...
public class basepage {
 ...
 public static void login(String str, String Str1) throws MalformedURLException, InterruptedException {
...
//android.widget.EditText[@index='2']
 ...
 driver.findElementByXPath("//android.widget.EditText[(@resource-id='com.pazo.ppz:id/etemail')]").sendKeys(str);
 driver.hideKeyboard();
 //plus.click();
 ...
 driver.findElementByXPath("//android.widget.EditText[(@resource-id='com.pazo.ppz:id/etpin')]").sendKeys(Str1);
 driver.hideKeyboard();
 //plus1.click();
